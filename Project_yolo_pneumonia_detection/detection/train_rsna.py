...
def parse_args():
    ...
    parser.add_argument('-s', '--split', type=int, default=5, help='training split number (1-5)')
    parser.add_argument('-a', '--anchors', default=[53,51, 64,90, 76,132, 82,64, 87,192, 98,98, 107,141, 114,202, 122,264])
